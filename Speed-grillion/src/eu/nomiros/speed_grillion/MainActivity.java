...
public class MainActivity extends Activity implements LocationListener {
    ...
    protected void onStart() {
        ...
        String defaults = "30, 50, 90, 110, 130", limits = prefs.getString("pref_key_limit_list", defaults);

        if (!LimitList.checkString(limits)) {
            Toast.makeText(this, getResources().getString(R.string.error_invalid_limitlist), Toast.LENGTH_SHORT).show();
        ...
        try {
            ...
            Toast.makeText(this, getResources().getString(R.string.error_invalid_threshold), Toast.LENGTH_SHORT).show();

            SharedPreferences.Editor edit = prefs.edit();
            edit.putInt("pref_key_alarm_threshold", 6);
            edit.commit();
